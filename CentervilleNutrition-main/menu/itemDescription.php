...
if (isset($_SESSION['customize_item_id'])) {
    ...
    if (mysqli_num_rows($item_query) > 0) {
        ...
        if($row['ImagePath'] == "none")
        {
            ...
            {
                $item_image = "<img src='../images/menuImages/Shake.png' class='item-main-img' alt='picture of a shake'>";
                $type = "Protein Shake";
                $type2 = "shake";
            }
            else
            {
                $item_image = "<img src='../images/menuImages/Tea.png' class='item-main-img' alt='picture of a tea'>";
                $type = "Tea Bomb";
                $type2 = "tea";
            }
        }
