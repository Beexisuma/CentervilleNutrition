<?php include('references/header2.php');
...
?>
			<div class="main-content admin-content">
				<div id="adminNav" class="admin-left mobile-nav">
					...
					<!--Admin Menu Btns-->
					<section>
						<a class="admin-switch user-switch">
							<svg
								version="1.1"
						...
						<a class="admin-switch drink-switch">
							<svg
								version="1.1"
						...
						<a class="admin-switch history-switch">
							<svg
								version="1.1"
...
if (isset($_POST['search-submit'])) {
    ...
    if($_POST['search'] != "") {
    echo("<h3 style='color: orange;'>Showing Results for: " . $_POST['search'] . "</h3>");
    echo("<form method='POST'><input type='submit' name='reload' value='Clear Search Results'></form>");
    }
    ...
    $menu_query = mysqli_query($con, "SELECT ItemID, Name, Description, Price, Type, InStock FROM menu WHERE Name LIKE '%$search_query%' OR Description LIKE '%$search_query%'");
} else {
...
>
    ...
    // Process the adding of a new menu item
            ...
            $_SESSION['bad'] = "<div class='error'>Error adding menu item: " . mysqli_error($con) . "</div>";
					...
					<div class="admin-relative">
						<button class="admin-add" onclick="addNav()">
							<img src="references/admin/menu.png" />
						</button>
						<button class="admin-add" onclick="addPop()">
							<img src="references/admin/plus.png" />
						</button>
					</div>
				</div>
					...
					<div class="insert-box">
						...
						<form class="insert-form" method="">
							...
							<section id="drinkInputs">
								...
								<span>
									<p>Image:</p>
									<input class="insert-file" type="file" />
								</span>
							</section>
							<!--END--------------------------------------------------------->
