             ...
             <div class="checkout-list">
                 ...
                 if (isset($_SESSION['itemArray']) && count($_SESSION['itemArray']) > 0) {
                     ...
                     if (isset($_SESSION['subtract']) && $_SESSION['subtract'] == 1) {
                         ...
                         echo "<div class='checkout-item'>";
                         echo "<p>Free Drink</p>";
                         echo "<p>-$" .  number_format($_SESSION['highestDrink'],2) . "</p>";
                         echo "</div>";
                         $subtotal -= $_SESSION['highestDrink'];
                     }
        ...
        if ($cartID_query && mysqli_num_rows($cartID_query) > 0) {
            ...
            if ($currentPunch_query && mysqli_num_rows($currentPunch_query) > 0) {
                ...
                if ($update_res) {
                    ...
                    // receipt admin logic
                    $itemArray = $dataClass->cartToString($_SESSION['itemArray']); 
                    $date = getTime();

                    $dataClass->addData('receipts',"Email='$email', PurchasedCart='$itemArray', Cost='$total', Date='$date', Free ='$free'");
...
?>
					...
					<div class="other-payment">
						<div class="other-btn"><img src="../images/paypal.png"></div>
						<div class="other-btn"><img src="../images/applepay.png"></div>
