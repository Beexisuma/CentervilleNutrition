...
if (isset($_SESSION['cartChecked']) && $_SESSION['cartChecked'] == 'yes') {
    echo "<script>
        ...
        if (isset($_POST['deleteButton'])) {
            ...
            // remove the item from array by position
            $count = 0;
                ...
                while ($row = mysqli_fetch_assoc($cartQuery)) {
                    ...
                    echo "</div>
                            ...
                            <section>
                                ...
                                <input type='hidden' name='cartItemID' value='" . $baseItemID . "' />
                                </form>
        ...
        {
            echo("<p>Sorry, you can not order we are not open right now</p>");
            echo ("<a class='cart-checkout-inactive' style='
